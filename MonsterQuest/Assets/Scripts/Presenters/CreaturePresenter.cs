...
namespace MonsterQuest
{
    public partial class CreaturePresenter : MonoBehaviour
    {
        ...
        public void Initialize(Creature creature)
        {
            ...
            _bodySpriteRenderer.sprite = _creature.myBodySprite;
            ...
            {
                standSpriteRenderer.sprite = standSprites[(int)_creature.mySizeCategory - 1];
            }

            // Set initial hit points.
            SetHitPointRatio((float)creature.myHitPoints / creature.myHitPointsMaximum);

            // Set initial standing/lying state.
            _standing = creature.myHitPoints > 0;
            ...
            float offset = _creature.mySpaceInFeet * 0.5f + 1.5f;
            ...
            foreach (bool deathSavingThrow in _creature.myDeathSavingThrows)
            {
